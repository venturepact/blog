<?php
/**
 * Transparent after-post theme class.
 *
 * @since   2.0.0
 *
 ...
 */
class Optin_Monster_Post_Theme_Transparent extends Optin_Monster_Theme {
    ...
    public function get_styles() {
        ...
        html div#om-' . $this->optin->post_name . ' #om-' . $this->type . '-' . $this->theme . '-optin-image-container .optin-monster-image-placeholder[style]{
	        width: 100% !important;
	    }
    ...
    public function get_html() {
        ...
        $html = '<div id="om-' . $this->type . '-' . $this->theme . '-optin" class="om-' . $this->type . '-' . $this->theme . ' om-clearfix om-theme-' . $this->theme . ' ' . ( $provider && 'custom' == $provider ? 'om-custom-html-form' : '' ) . '">';
            $html .= '<div id="om-' . $this->type . '-' . $this->theme . '-optin-wrap" class="om-clearfix" data-om-action="selectable" data-om-target="#optin-monster-field-body_border" style="border-color:' . $this->get_background_setting( 'border', '#474747' ) . '">';

                // Content area.
                $html .= '<div id="om-' . $this->type . '-' . $this->theme . '-content" class="om-clearfix" style="background-color:' . $this->get_background_setting( 'content', '#5c5c5c' ) . '">';
                ...
                $html .= '<div id="om-' . $this->type . '-' . $this->theme . '-footer" class="om-clearfix' . $class_name . '" data-om-action="selectable" data-om-target="#optin-monster-field-footer_bg" style="background-color:rgba(' . $this->hex2rgb( $this->get_background_setting( 'footer', '#fff' ) ) . ',.15);">';
    ...
    public function design_fields( $fields, $instance ) {
        ...
        $fields['body_border'] = $instance->get_color_field(
            'body_border',
            $instance->get_background_setting( 'border', '#474747' ),
        ...
        $fields['content_bg'] = $instance->get_color_field(
            'content_bg',
            $instance->get_background_setting( 'content', '#5c5c5c' ),
    ...
    public function input_fields( $fields, $instance ) {
        ...
        $fields['submit_bg'] = $instance->get_color_field(
            'submit_bg',
            $instance->get_submit_setting( 'bg_color', '#ff6200' ),
