jQuery( document ).ready(function( $ ){
    ...
    $( document ).on( 'click', '.fb-login', function( event ){
        ...
        FB.login( function( response ) {
             ...
             */
            if ( response && typeof(response.authResponse) != 'undefined' && typeof(response.authResponse.grantedScopes) != 'undefined' && response.authResponse.grantedScopes == "public_profile,email,contact_email" ){
