...
class XT_Dynamic_Styles {
	...
	public function set($element, $attr, $option_key) {
	...
	public function setBackground($element, $option_key) {
	...
	public function setBackgroundColor($element, $option_key) {
	...
	public function setColor($element, $option_key) {
	...
	public function setBorder($element, $option_key) {
	...
	public function setBorderColor($element, $option_key) {
