(function($){
	...
	*/
	...
	acf.fields.relationship_formats = {
		...
		fetch : function(){
		    ...
		    $.ajax({
				...
				dataType		:	'json',
				data			:	$.extend({ 
					action		:	'acf/fields/relationship_formats/query_posts', 
	...
	*/
	...
	$(document).on('acf/setup_fields', function(e, el){
		...
		$(el).find('.acf_relationship').each(function(){
			...
			acf.fields.relationship_formats.set({ $el : $(this) }).init();
	...
	*/
	...
	$(document).on('change', '.acf_relationship .select-post_type', function(e){
	    ...
	    // fetch
	    acf.fields.relationship_formats.set({ $el : $el }).fetch();
		
	});

	$(document).on('change', '.acf_relationship .select-post_format', function(e){
	...
	$(document).on('click', '.acf_relationship .relationship_left .relationship_list a', function( e ){
		...
		acf.fields.relationship_formats.set({ $el : $(this).closest('.acf_relationship') }).add( $(this) );
	...
	$(document).on('click', '.acf_relationship .relationship_right .relationship_list a', function( e ){
		...
		acf.fields.relationship_formats.set({ $el : $(this).closest('.acf_relationship') }).remove( $(this) );
	...
	$(document).on('keyup', '.acf_relationship input.relationship_search', function( e ){
	    ...
	    // fetch
	    clearTimeout( acf.fields.relationship_formats.timeout );
	    acf.fields.relationship_formats.timeout = setTimeout(function(){
