...
<div class="row no-col-padding">
	...
	<div class="medium-5 column">
		...
		<div id="order_review" class="box-grey">
			<h3><?php _e( 'Order Details', 'woocommerce' ); ?></h3>
			<table class="xt_shop_table order_details">
							...
							<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
								<td class="product-name">
									<?php
										...
										echo apply_filters( 'woocommerce_order_item_quantity_html', ' <strong class="product-quantity">' . sprintf( '%s: %s',  __('Quantity', 'woocommerce'), $item['qty'] ) . '</strong>', $item );
