...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form">
		...
		<p style="margin-bottom:0;padding-top:5px;padding-left:5px;"><button type="submit" name="calc_shipping" value="1" class="button secondary"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
