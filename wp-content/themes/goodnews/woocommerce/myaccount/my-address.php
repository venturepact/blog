...
<div class="row collapse">
	<div class="small-12 medium-8 column">
		...
		<div class="addresses">
			...
			<p class="myaccount_address large">
				<strong><?php echo apply_filters( 'woocommerce_my_account_my_address_description', __( 'The following addresses will be used on the checkout page by default.', 'woocommerce' ) ); ?></strong>
			</p>
...
<div class="woo_seperator transparent"></div>