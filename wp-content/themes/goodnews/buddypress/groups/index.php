		...
		<div class="item-list-tabs" id="subnav" role="navigation">
			<ul>
				...
				<?php if ( is_user_logged_in() ) : 
					...
					$groups_page_id = !empty($pages["groups"]) ? $pages["groups"] : '';
					if(empty($groups_page_id)) {
						$groups_url = bp_get_root_domain() . '/' . BP_GROUPS_SLUG . '/create/';
					}else{
						$groups_url = get_permalink($groups_page_id).'/create/';
					}
				?> 
				<li class="right">
					<a class="button" href="<?php echo esc_url($groups_url); ?>"><?php _e( 'Create a Group', 'buddypress' ) ?></a>
				</li>
				<?php endif; ?>		
				<li id="groups-dir-search" class="dir-search right" role="search">
